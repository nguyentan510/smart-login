...
<div class="omniwp sl-checkout-page-wrap alignwide sl-co-shopee">
	<div class="sl-co-container">
		...
		<div class="sl-co-progress" id="sl-co-progress">
			<div class="sl-co-progress__step sl-co-progress__step--active" data-step="1">
				<span class="sl-co-progress__circle">1</span>
				<span class="sl-co-progress__label"><?php esc_html_e( 'Địa chỉ', 'omniwp' ); ?></span>
			</div>
			<div class="sl-co-progress__line sl-co-progress__line--active"></div>
			<div class="sl-co-progress__step sl-co-progress__step--active" data-step="2">
				<span class="sl-co-progress__circle">2</span>
				<span class="sl-co-progress__label"><?php esc_html_e( 'Đơn hàng', 'omniwp' ); ?></span>
			</div>
			<div class="sl-co-progress__line"></div>
			<div class="sl-co-progress__step" data-step="3">
				<span class="sl-co-progress__circle">3</span>
				<span class="sl-co-progress__label"><?php esc_html_e( 'Thanh toán', 'omniwp' ); ?></span>
			</div>
		</div>

		<?php do_action( 'woocommerce_before_checkout_form', $checkout ); ?>

		<form name="checkout" method="post" class="checkout woocommerce-checkout sl-checkout-form sl-co-form" action="<?php echo esc_url( $checkout_url ); ?>" enctype="multipart/form-data">
